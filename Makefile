...
INSTALL_LIB_DIR = /usr/local/lib/9cc
INSTALL_MAN_DIR = /usr/local/share/man/man1/
# 9CC_LIB_DIR = "$(shell pwd)"
9CC_LIB_DIR ?= $(INSTALL_LIB_DIR)

# build dir
BUILD_DIR = build/

# targets
BURG = $(BUILD_DIR)burg/burg
9CC = $(BUILD_DIR)9cc
CC1 = $(BUILD_DIR)cc1
...
# obects
9CC_OBJ += $(BUILD_DIR)9cc.o

ARCH_SPEC = x86_64-linux.brg
...
BURG_INC += burg/burg.h

BURG_OBJ += $(BUILD_DIR)burg/burg.o
BURG_OBJ += $(BUILD_DIR)burg/grammar.o
...
all:: config.h $(9CC) $(CC1)

$(9CC): $(9CC_OBJ) $(LIBUTILS)
	$(CC) $^ $(LDFLAGS) -o $@
...
$(ARCH_SRC): $(ARCH_SPEC) $(CC1_INC) $(BURG)
	$(BURG) $(ARCH_SPEC) -o $@
...
install:: config.h  $(9CC) $(CC1)
	...
	cp doc/9cc.1 $(INSTALL_MAN_DIR)
	mkdir -p $(INSTALL_LIB_DIR)
	cp $(CC1) $(INSTALL_LIB_DIR)
	cp -R include $(INSTALL_LIB_DIR)

uninstall::
	rm -f $(INSTALL_BIN_DIR)9cc
	rm -rf $(INSTALL_LIB_DIR)
	rm -f $(INSTALL_MAN_DIR)9cc.1
