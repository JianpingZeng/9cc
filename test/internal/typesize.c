...
static void test_struct1()
{
	...
	xx(24, 16, {
	   struct {
	   int b; double d;} s; char a;};);

	xx(32, 24, {
	   struct C {
	   int b; char a[1];} c; struct C array[3];};);

	yy(28, 24, struct C {
	   int b; char a[1];};, {
	   char a; struct C array[3];};);
}
...
static void test_struct2()
{
	...
	xx(4, 4, {
	   char a:1; short b:1; int c:1;};);

	xx(4, 4, {
	   char a:1; short b:1; char:0; int c:1;};);

	xx(4, 4, {
	   char a:1; short b:1; short:0; int c:1;};);

	xx(8, 4, {
	   char a:1; short b:1; int:0; int c:1;};);

	xx(8, 4, {
	   char a:1; short b:1; unsigned:0; int c:1;};);

	xx(3, 1, {
	   char a:1; short:0; char c:1;};);

	xx(2, 2, {
	   char a:1; short b:1; char:0;};);

	xx(2, 2, {
	   short a:1; char b:1; char:0;};);

	xx(2, 2, {
	   short a:6; char b:5; char:0;};);
}
